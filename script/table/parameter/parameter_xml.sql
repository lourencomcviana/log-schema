...
alter table LOG_AUDIT.T_PARAMETER_xml
  add constraint PK_PARAMETER_xml primary key (DATA_LOG, SEQ, COD_UPDATE, NAME)
  ;

alter table LOG_AUDIT.T_PARAMETER_xml
  add constraint FK_PARAMETER_xml foreign key (DATA_LOG, SEQ, COD_UPDATE, NAME)
